...
**Last updated:** 2026-04-23 — Session 004 (checkpoint 22 — swap name-search from raw `requests` to `yfinance.Search` after user hit Yahoo IP-level 429s; on top of checkpoint 21's name-based search and checkpoint 20's macro fire-on-first-add)
